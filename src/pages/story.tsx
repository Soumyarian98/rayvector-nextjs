...
const Story = () => {
  return (
    <body className="min-h-screen bg-white selection:bg-primary/10 selection:text-primary dark:bg-gray-900">
      ...
      <section className="relative pt-32 sm:pt-36 md:pt-40 lg:pt-56">
        <div
          aria-hidden="true"
        ...
        <div className="relative mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="text-center sm:mx-auto sm:w-3/4 md:w-2/4 lg:w-auto">
              <img
          ...
          <div className="relative -mx-4 mt-4 flex snap-x snap-mandatory justify-between gap-6 overflow-x-auto border-b border-gray-100 px-4 py-8 dark:border-gray-800 sm:-mx-12 sm:px-12 lg:mx-0 lg:mt-16 lg:border-y lg:px-0">
              ...
              <div className="sticky">
                ...
                <div className="mt-6 mr-[-0.80rem] space-y-4 text-2xl text-gray-500 dark:text-gray-400">
                  <ul className="relative space-y-3 border-l px-6 text-base dark:border-gray-700">
                    ...
                    <li
                      data-target="problem"
                      className="section-link relative before:absolute before:top-0 before:bottom-0 before:-left-6 before:my-auto before:h-[1px] before:w-3 before:bg-gray-200 dark:before:bg-gray-800">
                      <Link
                        href="#problem"
                        className="py-2 duration-300 hover:text-primary dark:hover:text-secondaryLight">
                        Problem
            ...
            <div className="space-y-12 text-gray-600 dark:text-gray-400 lg:col-span-4 xl:col-span-4 xl:col-start-2">
              <div className="space-y-6">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white md:text-3xl">
                  Supernova's Seed Round and Our New Design Token Manager
                </h2>
              ...
              <div className="space-y-6">
                ...
                <div className="grid gap-6 md:grid-cols-3 lg:-ml-48 xl:-mx-48">
                  <img
                  ...
                  <div className="mt-6 space-y-6 sm:mt-0 sm:w-2/3 md:w-3/5 lg:w-2/3">
                    <div className="">
                      ...
                      <div className="relative my-4 before:absolute before:inset-y-0 before:-left-0.5 before:z-[1] before:my-auto before:h-1 before:w-1 before:rounded-full before:bg-gray-400 after:absolute after:inset-y-0 after:-right-0.5 after:z-[1] after:my-auto after:h-1 after:w-1 after:rounded-full after:bg-gray-400">
                        <div
                          aria-hidden="true"
                          className="absolute inset-0 m-auto h-px w-full border-t border-dashed dark:border-gray-600"></div>
