...
const Contact = () => {
  return (
    <body className="min-h-screen overflow-x-hidden bg-white selection:bg-primary/10 selection:text-primary dark:bg-gray-900">
      <header>
        <nav
          id="navbar"
        ...
        <div className="mx-auto px-4 sm:px-12 xl:max-w-5xl xl:px-0">
          <div className="relative z-10 text-center md:mx-auto md:w-5/6 lg:w-4/6">
            <h1 className="relative text-center text-4xl font-bold text-gray-900 dark:text-white sm:text-5xl md:text-6xl">
              Start building <span className="opacity-80">here.</span>
            </h1>
          ...
          <div className="mt-12 grid gap-12 sm:mx-auto sm:max-w-lg lg:max-w-max lg:grid-cols-2">
              ...
              <form
                ...
                <div className="relative">
                  ...
                  <p className="mb-8 text-sm text-gray-600 dark:text-gray-300">
                    By clicking submit below, you agree to the processing of
                    your personal information by PlanetScale as described in the
                    Privacy Policy.
                  </p>
            ...
            <div>
              ...
              <div className="mt-12 text-center">
                <Link
                  href="./customers.html"
                  className="text-sm font-semibold tracking-widest dark:text-white">
                  TRUSTED BY TOP TECHS COMPANIES
                </Link>
