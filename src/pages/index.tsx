            ...
            <div className="relative  gap-12 lg:flex">
              <div className="text-center sm:mx-auto sm:w-11/12 md:mt-12 md:w-4/5 lg:mt-0 lg:mr-auto lg:w-6/12 lg:text-left">
                <p className="mt-12 text-lg text-gray-600 dark:text-gray-300 sm:text-xl">
                  We transform visionary ideas into tangible products that shape
                  the future. With a passionate team of innovators, engineers,
                  and designers, we specialize in end-to-end product development
                  that marries creativity, technology, and strategic thinking.
                </p>
