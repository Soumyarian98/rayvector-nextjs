        ...
        <div className="mx-auto px-4 sm:px-12 xl:max-w-5xl xl:px-0">
          ...
          <div className="relative mt-20">
              ...
              <div className="relative mx-4 rounded-3xl rounded-t-none border border-gray-700 bg-gray-800 shadow-2xl shadow-gray-600/10 dark:border-gray-100 dark:bg-white dark:shadow-none md:mx-0 md:w-6/12 md:rounded-l-none md:rounded-tl-none md:rounded-tr-3xl lg:w-7/12">
                <div className="relative p-6 pt-16 md:rounded-r-2xl md:p-8 md:pl-9 lg:p-16 lg:pl-[4.375rem]">
                  ...
                  <p className="my-8 text-white dark:text-gray-700">
                    Voluptatum iure rerum qui Voluptates dignissimos quibusdam
                    reiciendis soluta tempore illum possimus esse.
                  </p>
            ...
            <div className="mt-12 text-center">
              <a
                href="./customers.html"
                className="text-sm font-semibold tracking-wider dark:text-white">
      ...
      <section className="mt-32">
        <div className="mx-auto px-4 sm:px-12 xl:max-w-5xl xl:px-0">
          ...
          <div className="mx-auto max-w-2xl space-y-16 lg:hidden">
            <section>
              <div className="relative h-full space-y-8 border-t border-gray-100 py-8 dark:border-gray-700">
                <img
                  src="https://tailus.io/sources/blocks/comparator/preview/images/team.webp"
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Delectus natus illum vel veritatis in, iste ut facilis ex
                    sit culpa fuga dolor atque? Quis.
                  </p>
                </div>
                <a
                  href="contact.html"
                  className="relative flex h-9 w-full items-center justify-center px-6 before:absolute before:inset-0 before:rounded-full before:bg-secondary before:transition before:duration-300 active:duration-75 active:before:scale-95 dark:before:bg-white">
              ...
              <table className="w-full">
                <caption className="border-t border-gray-200 bg-gray-50 py-3 px-4 text-left text-sm font-medium text-gray-900 dark:border-gray-700 dark:bg-gray-800 dark:text-white">
                  Features
                </caption>
                <thead>
                  <tr>
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  <tr className="border-t border-gray-200 dark:border-gray-800">
                    <th
                      className="py-5 px-4 text-left text-sm font-normal text-gray-600 dark:text-gray-400"
                      scope="row">
                      Feature 1
                    </th>
                    <td className="py-5 pr-4">
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        fill="currentColor"
                        className="ml-auto h-6 w-6 text-secondary dark:text-secondaryLight">
                        <path
                          fill-rule="evenodd"
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  ...
                  <tr className="border-t border-gray-200 dark:border-gray-800">
                    ...
                    <td className="py-5 pr-4">
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        fill="currentColor"
                        className="ml-auto h-6 w-6 text-gray-400 dark:text-gray-600">
                        <path
                          fill-rule="evenodd"
                  ...
                  <tr className="border-t border-gray-200 dark:border-gray-800">
                    <th
                      className="py-5 px-4 text-left text-sm font-normal text-gray-600 dark:text-gray-400"
                      scope="row">
                      Reporting feature new and great for long text3
                    </th>
                    <td className="py-5 pr-4">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
            ...
            <section>
              <div className="relative table h-full space-y-8 border-t border-gray-100 py-8 dark:border-gray-700">
                <img
                  src="https://tailus.io/sources/blocks/comparator/preview/images/organization.webp"
                  className="h-12 w-auto"
                  alt="team icon"
                ...
                <a
                  href="contact.html"
                  className="relative flex h-9 w-full items-center justify-center px-6 before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition-transform before:duration-300 active:duration-75 active:before:scale-95 dark:before:bg-primaryLight">
                  ...
                  <tr className="border-t border-gray-200 dark:border-gray-800">
                    ...
                    <td className="py-5 pr-4">
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        fill="currentColor"
                        className="ml-auto h-6 w-6 text-primary dark:text-primaryLight">
                        <path
                          fill-rule="evenodd"
                          d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zm13.36-1.814a.75.75 0 10-1.22-.872l-3.236 4.53L9.53 12.22a.75.75 0 00-1.06 1.06l2.25 2.25a.75.75 0 001.14-.094l3.75-5.25z"
                          clip-rule="evenodd"
          ...
          <div className="hidden lg:block">
            <table className="h-px w-full table-fixed">
              ...
              <thead>
                <tr>
                  <th
                    className="w-1/3 px-6 pb-4 text-left text-sm font-medium text-gray-900"
                    scope="col">
                    <span className="sr-only">Feature by</span>
                    <span></span>
                  </th>
                  <th
                    className="w-1/3 px-6 pb-4 text-left text-lg font-medium leading-6 text-gray-900"
                    scope="col"></th>
                  <th
                    className="w-1/3 px-6 pb-4 text-left text-lg font-medium leading-6 text-gray-900"
                    scope="col"></th>
              ...
              <tbody className="divide-y divide-gray-200 border-x border-b border-gray-200 dark:divide-gray-700 dark:border-gray-700 [&>*]:divide-x [&>*]:divide-gray-200 [&>*]:dark:divide-gray-700">
                <tr>
                  <th
                    className="border-l border-white py-8 px-6 text-left align-top text-sm font-medium text-gray-900 dark:border-gray-900"
                    scope="row"></th>
                  ...
                  <td className="h-full border-t py-12 px-6 align-top">
                    <div className="relative table h-full space-y-8">
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          Delectus natus illum vel veritatis in, iste ut facilis
                          ex sit culpa fuga dolor atque? Quis.
                        </p>
                      </div>
                      <a
                        href="contact.html"
                  ...
                  <td className="h-full border-t bg-gray-50 py-12 px-6 align-top dark:bg-gray-800">
                    <div className="relative table h-full space-y-8">
                      <img
                        src="https://tailus.io/sources/blocks/comparator/preview/images/organization.webp"
                        className="h-12 w-auto"
                ...
                <tr>
                  <th
                    className="bg-gray-50 py-3 pl-6 text-left text-sm font-medium text-gray-900 dark:bg-gray-800 dark:text-white"
                    colSpan={4}
                    scope="colgroup">
                    Features
                  </th>
                ...
                <tr>
                  <th
                    className="py-5 px-6 text-left text-sm font-normal text-gray-600 dark:text-gray-400"
                    scope="row">
                    Feature 1
                  </th>
                  ...
                  <td className="py-5 px-6">
                    <svg
                      ...
                      viewBox="0 0 24 24"
                      fill="currentColor"
                      className="mx-auto h-6 w-6 text-secondary dark:text-secondaryLight">
                      <path
                        fill-rule="evenodd"
                        d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zm13.36-1.814a.75.75 0 10-1.22-.872l-3.236 4.53L9.53 12.22a.75.75 0 00-1.06 1.06l2.25 2.25a.75.75 0 001.14-.094l3.75-5.25z"
                        clip-rule="evenodd"
                  ...
                  <td className="bg-gray-50 py-5 px-6 dark:bg-gray-800">
                    <svg
                      ...
                      viewBox="0 0 24 24"
                      fill="currentColor"
                      className="mx-auto h-6 w-6 text-primary dark:text-primaryLight">
                      <path
                        fill-rule="evenodd"
                        d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zm13.36-1.814a.75.75 0 10-1.22-.872l-3.236 4.53L9.53 12.22a.75.75 0 00-1.06 1.06l2.25 2.25a.75.75 0 001.14-.094l3.75-5.25z"
                        clip-rule="evenodd"
                ...
                <tr>
                  ...
                  <td className="py-5 px-6">
                    <svg
                      ...
                      viewBox="0 0 24 24"
                      fill="currentColor"
                      className="mx-auto h-6 w-6 text-gray-400 dark:text-gray-600">
                      <path
                        fill-rule="evenodd"
                        d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zm3 10.5a.75.75 0 000-1.5H9a.75.75 0 000 1.5h6z"
                        clip-rule="evenodd"
              ...
              <dl className="faq mx-auto max-w-2xl">
                <dt className="text-lg">
                  <button
                    ...
                    data-active="false">
                    <span className="font-medium text-gray-900 dark:text-white">
                      Are updates included in this pack ?
                    </span>
                    <span className="ml-6 flex h-7 items-center">
                      <svg
                        className="arrow-down h-6 w-6 rotate-0 transform duration-300"
